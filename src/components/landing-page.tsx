      ...
      <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6 bg-gradient-to-r from-[#84D25B] to-[#4CAF50] border-b">
        <Sheet>
          ...
          <SheetContent side="left">
            <Link href="#" className="flex items-center gap-2 py-4 px-6" prefetch={false}>
              <TrashIcon className="h-6 w-6" />
              <span className="font-bold text-lg font-['Roboto', 'sans-serif']">Waste Management</span>
            </Link>
                ...
                <div className="grid w-[400px] p-2">
                  <NavigationMenuLink asChild>
                    <Link
                      ...
                      prefetch={false}
                    >
                      <div className="text-sm font-medium leading-none group-hover:underline">Residential Waste</div>
                  ...
                  <NavigationMenuLink asChild>
                    <Link
                      ...
                      prefetch={false}
                    >
                      <div className="text-sm font-medium leading-none group-hover:underline">Commercial Waste</div>
                      <div className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                  ...
                  <NavigationMenuLink asChild>
                    <Link
                      ...
                      prefetch={false}
                    >
                      <div className="text-sm font-medium leading-none group-hover:underline">Recycling</div>
                      <div className="line-clamp-2 text-sm leading-snug text-muted-foreground">
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-white md:text-xl font-['Roboto', 'sans-serif']">
                  We provide reliable and eco-friendly waste collection and recycling services for residential and
